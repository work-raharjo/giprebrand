...
export const company = {
  ...
  short: "GIP",
  domain: "gip.co.id",
  address: "Jl. Buah Batu No. 161, Kota Bandung, Jawa Barat",
  phone: "022-87326585",
  waNumber: "6282126851122",
  email: "andy@gip.co.id",
...
export const verticals = {
  event: {
    ...
    heroSub:
      "Kami memasang, mengoperasikan, dan membongkar seluruh perangkat teknis event Anda. Satu tim, satu tanggung jawab.",
    image: "event",
    heroImage: "eventAlt",
  ...
  connect: {
    ...
    heroSub:
      "Desain, instalasi, monitoring, dan eskalasi dalam satu layanan terkelola. Tim Anda kembali fokus ke pekerjaan utama.",
    image: "connect",
    heroImage: "connect",
  ...
  marine: {
    ...
    cardBlurb: "Starlink dan konektivitas unlimited untuk kapal serta lokasi terpencil.",
    heroTitle: "Koneksi yang tidak putus, dari dermaga sampai perairan lepas",
    heroSub:
      "Instalasi, aktivasi, dan pengelolaan penuh oleh tim GIP. Anda cukup berlayar.",
    image: "marine",
    heroImage: "marineAlt",
    ...
    services: [
      ...
      { icon: "map-pin", title: "Lokasi terpencil", desc: "Tambang, perkebunan, dan site tanpa jaringan darat" },
      { icon: "headset", title: "Dukungan 24/7", desc: "NOC dan eskalasi langsung ke penyedia upstream" },
    ],
    proof: [
      { title: "Area cakupan", desc: "Konfirmasi ketersediaan berdasarkan rute operasi" },
      { title: "SLA dan uptime", desc: "Angka yang bisa diverifikasi, bukan klaim pemasaran" },
      { title: "Legalitas dan kepatuhan", desc: "Posisi GIP terhadap lisensi telekomunikasi upstream" },
    ],
    formFields: [
