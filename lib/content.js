...
export const partners = [
  { name: "Speedcast", src: "/partners/speedcast.svg" },
  { name: "Ruijie", src: "/partners/ruijie.png" },
  { name: "Ruckus", src: "/partners/ruckus.svg" },
  { name: "Multipolar Technology", src: "/partners/multipolar.webp" },
  { name: "Fortinet", src: "/partners/fortinet.png" },
  { name: "HPE Aruba", src: "/partners/aruba-wordmark.png" },
];
